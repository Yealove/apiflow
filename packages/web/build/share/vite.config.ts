...
export default defineConfig({
  ...
  define: {
    ...
    __APP_GITHUB_URL__: JSON.stringify('https://github.com/Yealove/apiflow'),
    __APP_GITEE_URL__: JSON.stringify('https://gitee.com/wildsell/apiflow'),
    __APP_RELEASE_URL__: JSON.stringify('https://github.com/Yealove/apiflow/releases'),
    __APP_LICENSE_URL__: JSON.stringify('https://github.com/Yealove/apiflow/blob/main/LICENSE'),
    __APP_COPYRIGHT__: JSON.stringify('Copyright © 2026 Yealove Team'),
